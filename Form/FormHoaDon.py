...
#Thao tac hien thi thong tin  
    ...
    #MaTuyen
        ...
        self.entry_MaThanhToan.place(x=120, y=105)
    #TenTuyen
    ...
    #TenDiaDiem
        ...
        self.lb_TenDichVu.place(x=20, y = 180)
        self.entry_TenDichVu = CTkEntry(self.frameTop, width=250, height=20)
        self.entry_TenDichVu.place(x=120, y=185)
    #TenDichVu
        self.lb_PhuongThuc = CTkLabel(self.frameTop, text= "Phương thức", font=("Segoe UI", 14))
        self.lb_PhuongThuc.place(x=20, y = 220)
        self.entry_PhuongThuc = CTkEntry(self.frameTop, width=250, height=20)
        self.entry_PhuongThuc.place(x=120, y=225)        
   
    #SoChoToiDa
        self.lb_SoTien = CTkLabel(self.frameTop, text= "Tổng tiền", font=("Segoe UI", 14))
        self.lb_SoTien.place(x=400, y = 100)
        self.entry_SoTien = CTkEntry(self.frameTop, width=250, height=20)
        self.entry_SoTien.place(x=510, y=105)         
    #SoChoConLai
        self.lb_TrangThai = CTkLabel(self.frameTop, text= "Trạng thái", font=("Segoe UI", 14))
        self.lb_TrangThai.place(x=400, y = 140)
        self.entry_TrangThai = CTkEntry(self.frameTop, width=250, height=20)
        self.entry_TrangThai.place(x=510, y=145)
    #NgayThanhToan
        self.lb_NgaySinh = CTkLabel(self.frameTop, text= "Ngày thanh toán", font=("Segoe UI", 14))
