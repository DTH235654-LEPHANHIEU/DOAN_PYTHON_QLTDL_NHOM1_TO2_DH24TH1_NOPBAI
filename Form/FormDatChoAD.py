...
#Thao tac hien thi thong tin  
    ...
    #MaTuyen
        self.lb_MaDichVu = CTkLabel(self.frameTop, text= "Mã dịch vụ", font=("Segoe UI", 14))
        self.lb_MaDichVu.place(x=20, y = 100) 
        self.entry_MaDichVu = CTkEntry(self.frameTop, width=250, height=20)
        self.entry_MaDichVu.place(x=120, y=105)
    #TenDichVu
        self.lb_TenDichVu = CTkLabel(self.frameTop, text= "Tên dịch vụ", font=("Segoe UI", 14))
        self.lb_TenDichVu.place(x=20, y = 140)
        self.entry_TenDichVu = CTkEntry(self.frameTop, width=250, height=20)
        self.entry_TenDichVu.place(x=120, y=145)
    #GiaDichVU
        self.lb_GiaDichVu = CTkLabel(self.frameTop, text= "Giá dịch vụ", font=("Segoe UI", 14))
        self.lb_GiaDichVu.place(x=20, y = 180)
        self.entry_GiaDichVu = CTkEntry(self.frameTop, width=250, height=20)
        self.entry_GiaDichVu.place(x=120, y=185)        
